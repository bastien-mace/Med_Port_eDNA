...
# ggsave("../plots/Alpha-div_Season_metazoa_predicted.tiff", alpha_div_predicted, dpi = 600, width = 15, height = 15, units = "cm")
...
# ggsave("../plots/Alpha-div_Season_metazoa.tiff", alpha_div, dpi = 600, width = 15, height = 15, units = "cm")

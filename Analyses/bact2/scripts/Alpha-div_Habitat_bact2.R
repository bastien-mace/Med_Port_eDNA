...
# ggsave("../plots/Alpha-div_Habitat_bact2_predicted.tiff", alpha_div_predicted, dpi = 600, width = 15, height = 15, units = "cm")
...
# ggsave("../plots/Alpha-div_Habitat_bact2.tiff", alpha_div, dpi = 600, width = 15, height = 15, units = "cm")

...
richness_table <- read.csv2("../data/teleo_richness.csv") %>%
...
# ggsave("../plots/Alpha-div_Habitat_teleo_predicted.tiff", alpha_div_predicted, dpi = 600, width = 15, height = 15, units = "cm")
...
# ggsave("../plots/Alpha-div_Habitat_teleo.tiff", alpha_div, dpi = 600, width = 15, height = 15, units = "cm")

...
# ggsave("../plots/Alpha-div_Season_euka2_predicted.tiff", alpha_div_predicted, dpi = 600, width = 15, height = 15, units = "cm")
...
# ggsave("../plots/Alpha-div_Season_euka2.tiff", alpha_div, dpi = 600, width = 15, height = 15, units = "cm")

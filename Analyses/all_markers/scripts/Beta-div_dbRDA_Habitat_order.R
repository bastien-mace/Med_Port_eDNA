...
# Set the model
dbRDA_order <- capscale(data_dbRDA_order ~ Habitat + Condition(Longitude + Latitude),
...
# ggsave("./plots/Beta-div_dbRDA_Habitat_order_sites.tiff", dbRDA_site_scores, dpi = 600, width = 20, height = 15, units = "cm")

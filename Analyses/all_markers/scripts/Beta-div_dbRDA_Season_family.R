...
# Set the model
dbRDA_family <- capscale(data_dbRDA_family ~ Season + Condition(Longitude + Latitude),
...
# ggsave("../plots/Beta-div_dbRDA_Season_family_sites.tiff", dbRDA_site_scores, dpi = 600, width = 20, height = 15, units = "cm")

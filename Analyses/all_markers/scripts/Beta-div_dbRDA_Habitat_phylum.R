...
# Set the model
dbRDA_phylum <- capscale(data_dbRDA_phylum ~ Habitat + Condition(Longitude + Latitude),
...
# ggsave("./plots/Beta-div_dbRDA_Habitat_phylum_sites.tiff", dbRDA_site_scores, dpi = 600, width = 20, height = 15, units = "cm")
...
dbRDA_species_scores <- ggplot() + 
  ...
  guides(color = guide_legend(override.aes = list(labels = c("Eukaryotes", "Metazoans", "Fish")),
                              keywidth = 4)) +

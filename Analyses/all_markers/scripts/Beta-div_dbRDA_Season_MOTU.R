...
# Set the model
dbRDA_motu <- capscale(data_dbRDA_motu ~ Season + Condition(Longitude + Latitude),
...
# ggsave("./plots/Beta-div_dbRDA_Season_MOTU_sites.tiff", dbRDA_site_scores, dpi = 600, width = 20, height = 15, units = "cm")
...
assignments$scientific_name <- gsub("unidentified.*", "", assignments$scientific_name)
...
assignments$scientific_name <- gsub("MD3-55", "", assignments$scientific_name)
...
# ggsave("../plots/Beta-div_dbRDA_Season_MOTU_species.tiff", dbRDA_species_scores, dpi = 600, width = 20, height = 15, units = "cm")

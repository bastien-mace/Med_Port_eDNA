...
# Set the model
dbRDA_class <- capscale(data_dbRDA_class ~ Season + Condition(Longitude + Latitude),
...
# ggsave("../plots/Beta-div_dbRDA_Season_class_sites.tiff", dbRDA_site_scores, dpi = 600, width = 20, height = 15, units = "cm")
